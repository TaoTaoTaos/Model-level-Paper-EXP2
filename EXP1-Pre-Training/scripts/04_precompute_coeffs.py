...
from lakeice_ncde.app import build_coeff_artifacts, build_common_parser, resolve_runtime, resolve_split_manifest_path


def main() -> None:
    parser = build_common_parser("Precompute NeuralCDE interpolation coefficients.")
    ...
    build_coeff_artifacts(config, paths, logger, split_manifests=split_manifests)
